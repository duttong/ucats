...
RHstruct vai;
 ...
 typedef float vaifloat; /* edf2ext.awk reading o3data.edf */
  #include <stdlib.h>
  #include "ssp.h"
  #include "tmctime.h"
  ...
  void initialize(void) {
	...
	o3out = edf_ss_open( "o3out", 13 );
	ss_set_column(o3out, 0, "%14.11lt", "Time");
	ss_set_column(o3out, 1, "%12.1f", "o3yy");
	ss_set_column(o3out, 2, "%12.1f", "o3mm");
	ss_set_column(o3out, 3, "%12.1f", "o3dd");
	ss_set_column(o3out, 4, "%12.1f", "o3hh");
	ss_set_column(o3out, 5, "%12.1f", "o3min");
	ss_set_column(o3out, 6, "%12.1f", "o3ss");
	ss_set_column(o3out, 7, "%12.1f", "o3");
	ss_set_column(o3out, 8, "%12.1f", "o3temp");
	ss_set_column(o3out, 9, "%12.1f", "o3pres");
	ss_set_column(o3out, 10, "%12.1f", "o3best");
	ss_set_column(o3out, 11, "%12.3f", "o3lmpv");
	ss_set_column(o3out, 12, "%12.3f", "o3lmpsd");
  }
  void terminate(void) {
	ss_close(o3out);
  }
...
static void BF128_15(void) {
  o3lmpsd = home->U31.o3lmpsd;
  V10 &= ~0x80;
  EF16_15();
}

static void BF128_31(void) {
  o3lmpv = home->U29.o3lmpv;
  V10 &= ~0x40;
  EF16_15();
}
...
static void BF128_127(void) {
  ...
  if (!(V10)) {
    {
      ss_insert_value(o3out, dtime()+ext_delta, 0);
      ss_set(o3out, 1, home->U35.o3yy);
      ss_set(o3out, 2, o3mm);
      ss_set(o3out, 3, o3dd);
      ss_set(o3out, 4, o3hh);
      ss_set(o3out, 5, o3min);
      ss_set(o3out, 6, home->U37.o3ss);
      ss_set(o3out, 7, o3);
      ss_set(o3out, 8, o3temp);
      ss_set(o3out, 9, o3pres);
      ss_set(o3out, 10, o3best);
      ss_set(o3out, 11, o3lmpv);
      ss_set(o3out, 12, o3lmpsd);
    }
  }
}
...
static void IVF128_79(void) {
  V10 |= 0x4;
}
static void IVF128_95(void) {
  V10 |= 0x2;
}
static void IVF128_111(void) {
  V10 |= 0x1;
}
#define IVFUNCS

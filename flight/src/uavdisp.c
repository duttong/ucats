...
int secondhalf;
  ...
  #include "rtgapi.h"
  rtg_t *chromCH3_rtg[2];
  int chromCH3_rtginc = 1;
  ...
  void rtgext_init( void ) {
    chromCH3_rtg[0] = rtg_init( "chromCH3/0" );
    chromCH3_rtg[1] = rtg_init( "chromCH3/1" );
...
double _CVT_12( o3float x ) {
  return (double) floor(  x  * 1E1 + .5 );
}
/* _CVT_13() int tcvt o3float -> o3float */
char *_CVT_13(o3float x) {
  double iv;
...
/* _CVT_14() int tcvt valvT -> valvT */
char *_CVT_14(valvT x) {
  if ( x < 0 || x > 999 )
	return "***";
...
/* _CVT_15() int tcvt OmegaTsp -> OmegaTsp */
char *_CVT_15(OmegaTsp x) {
  if ( x < -9999 )
	return "******";
  return SS_6_1_f_4( x );
}
/* _CVT_16() int tcvt OmegaT -> OmegaT */
char *_CVT_16(OmegaT x) {
  if ( x < -9999 )
	return "******";
  return SS_6_1_f_4( x );
}
/* doub_cvt for PSIH -> PRESS */
double _CVT_17( PSIH x ) {
  double ov;
...
double _CVT_18( PSIH x ) {
  return (double) floor( _CVT_17( x ) * 1E1 + .5 );
}
/* _CVT_19() int tcvt PSIH -> PRESS */
char *_CVT_19(PSIH x) {
  double iv;
...
double _CVT_21( PSIL x ) {
  return (double) floor( _CVT_20( x ) * 1E1 + .5 );
}
/* _CVT_22() int tcvt PSIL -> PRESS */
char *_CVT_22(PSIL x) {
  double iv;
...
/* doub_cvt for PSIBspPN -> PRESS */
double _CVT_23( PSIBspPN x ) {
  double ov;
...
/* doub icvt for PSIBspPN -> PRESS */
double _CVT_24( PSIBspPN x ) {
  return (double) floor( _CVT_23( x ) * 1E1 + .5 );
}
/* _CVT_25() int tcvt PSIBspPN -> PRESS */
char *_CVT_25(PSIBspPN x) {
  double iv;
...
/* doub icvt for PSIBpnu -> PRESS */
double _CVT_27( PSIBpnu x ) {
  return (double) floor( _CVT_26( x ) * 1E1 + .5 );
}
/* _CVT_28() int tcvt PSIBpnu -> PRESS */
char *_CVT_28(PSIBpnu x) {
  double iv;
...
double _CVT_30( SCCMsl x ) {
  return (double) floor( _CVT_29( x ) * 1E1 + .5 );
}
/* _CVT_31() int tcvt SCCMsl -> FLOW */
char *_CVT_31(SCCMsl x) {
  double iv;
...
/* doub_cvt for SCCMspPN -> FLOW */
double _CVT_32( SCCMspPN x ) {
  double ov;
...
/* doub icvt for SCCMspPN -> FLOW */
double _CVT_33( SCCMspPN x ) {
  return (double) floor( _CVT_32( x ) * 1E1 + .5 );
}
/* _CVT_34() int tcvt SCCMspPN -> FLOW */
char *_CVT_34(SCCMspPN x) {
  double iv;
...
/* doub icvt for SCCMpnu -> FLOW */
double _CVT_36( SCCMpnu x ) {
  return (double) floor( _CVT_35( x ) * 1E1 + .5 );
}
/* _CVT_37() int tcvt SCCMpnu -> FLOW */
char *_CVT_37(SCCMpnu x) {
  double iv;
...
double _CVT_39( CELS x ) {
  return (double) floor( _CVT_38( x ) * 1E1 + .5 );
}
/* _CVT_40() int tcvt CELS -> TEMP */
char *_CVT_40(CELS x) {
  double iv;
...
/* doub icvt for MBARpnuSL -> PRESS */
double _CVT_42( MBARpnuSL x ) {
  return (double) floor( _CVT_41( x ) * 1E1 + .5 );
}
/* _CVT_43() int tcvt MBARpnuSL -> PRESS */
char *_CVT_43(MBARpnuSL x) {
  double iv;
...
/* doub icvt for MBARpnu -> PRESS */
double _CVT_45( MBARpnu x ) {
  return (double) floor( _CVT_44( x ) * 1E1 + .5 );
}
/* _CVT_46() int tcvt MBARpnu -> PRESS */
char *_CVT_46(MBARpnu x) {
  double iv;
...
double _CVT_48( MBAR x ) {
  return (double) floor( _CVT_47( x ) * 1E1 + .5 );
}
/* _CVT_49() int tcvt MBAR -> PRESS */
char *_CVT_49(MBAR x) {
  double iv;
...
double _CVT_51( VOLTS28 x ) {
  return (double) floor( _CVT_50( x ) * 1E1 + .5 );
}
/* _CVT_52() int tcvt VOLTS28 -> VOL5 */
char *_CVT_52(VOLTS28 x) {
  double iv;
...
double _CVT_54( VOLTSPM x ) {
  return (double) floor( _CVT_53( x ) * 1E1 + .5 );
}
/* _CVT_55() int tcvt VOLTSPM -> VOL5 */
char *_CVT_55(VOLTSPM x) {
  double iv;
...
double _CVT_57( VOLTS512 x ) {
  return (double) floor( _CVT_56( x ) * 1E1 + .5 );
}
/* _CVT_58() int tcvt VOLTS512 -> VOL5 */
char *_CVT_58(VOLTS512 x) {
  double iv;
...
/* _CVT_59() int tcvt GC_Freq -> GC_Freq */
char *_CVT_59(GC_Freq x) {
  if ( x < -99999 || x > 999999 )
	return "******";
...
/* _CVT_60() int tcvt ULONG -> ULONG */
char *_CVT_60(ULONG x) {
  if ( x > 999999 )
	return "******";
  return UL_6_0_u_0( x );
}
...
static void VSET_2_(unsigned short newstate) {
  ...
  switch (newstate) {
    ...
    case 1: /* GCInc */ {
        ...
        V13 &= ~0x1;
        {
          rtg_increment( chromCH3_rtginc, 2 );
...
static void tminitfunc(void) {VSET_0_(1);VSET_1_(1);VSET_2_(1);VSET_3_(1);VSET_4_(1);VSET_5_(1);
  cdisplay(0,10,19,Inject_Load_text[0]);
  cdisplay(0,11,8,_CVT_59(0));
  cdisplay(0,12,8,_CVT_37(0));
  cdisplay(0,12,15,_CVT_34(0));
  cdisplay(0,13,8,_CVT_37(0));
  cdisplay(0,13,15,_CVT_34(0));
  cdisplay(0,14,8,_CVT_28(0));
  cdisplay(0,14,15,_CVT_25(0));
  cdisplay(0,15,8,_CVT_46(0));
  cdisplay(0,16,8,_CVT_16(0));
  cdisplay(0,16,15,_CVT_15(0));
  cdisplay(0,17,8,_CVT_16(0));
  cdisplay(0,17,15,_CVT_15(0));
  cdisplay(0,18,8,_CVT_58(0));
  cdisplay(0,20,6,_CVT_1(0));
  cdisplay(0,10,45,Inject_Load_text[0]);
  cdisplay(0,11,35,_CVT_59(0));
  cdisplay(0,12,35,_CVT_37(0));
  cdisplay(0,12,42,_CVT_34(0));
  cdisplay(0,13,35,_CVT_37(0));
  cdisplay(0,13,42,_CVT_34(0));
  cdisplay(0,14,35,_CVT_28(0));
  cdisplay(0,14,42,_CVT_25(0));
  cdisplay(0,15,35,_CVT_46(0));
  cdisplay(0,16,35,_CVT_16(0));
  cdisplay(0,16,42,_CVT_15(0));
  cdisplay(0,17,35,_CVT_16(0));
  cdisplay(0,17,42,_CVT_15(0));
  cdisplay(0,19,34,_CVT_1(0));
  cdisplay(0,20,34,_CVT_1(0));
  cdisplay(0,10,70,Load_Inject_text[0]);
  cdisplay(0,11,60,_CVT_59(0));
  cdisplay(0,12,60,_CVT_37(0));
  cdisplay(0,12,67,_CVT_34(0));
  cdisplay(0,13,60,_CVT_37(0));
  cdisplay(0,13,67,_CVT_34(0));
  cdisplay(0,14,60,_CVT_28(0));
  cdisplay(0,15,60,_CVT_46(0));
  cdisplay(0,16,60,_CVT_16(0));
  cdisplay(0,16,67,_CVT_15(0));
  cdisplay(0,17,60,_CVT_16(0));
  cdisplay(0,17,67,_CVT_15(0));
  cdisplay(0,18,60,_CVT_16(0));
  cdisplay(0,18,67,_CVT_15(0));
  cdisplay(0,19,58,_CVT_1(0));
  cdisplay(0,20,58,_CVT_1(0));
  cdisplay(0,2,37,_CVT_40(0));
  cdisplay(0,3,37,_CVT_40(0));
  cdisplay(0,4,37,_CVT_40(0));
  cdisplay(0,5,37,_CVT_40(0));
  cdisplay(0,6,37,_CVT_40(0));
  cdisplay(0,7,37,_CVT_40(0));
  cdisplay(0,8,37,_CVT_40(0));
  cdisplay(0,1,20,Air_Cal_text[0]);
  cdisplay(0,2,12,_CVT_31(0));
  cdisplay(0,3,12,_CVT_43(0));
  cdisplay(0,4,6,Cl_Op_text[0]);
  cdisplay(0,4,18,Op_Cl_text[0]);
  cdisplay(0,6,11,_CVT_14(0));
  cdisplay(0,7,11,Cl_Op_text[0]);
  cdisplay(0,1,62,_CVT_58(0));
  cdisplay(0,2,62,_CVT_55(0));
  cdisplay(0,3,62,_CVT_52(0));
  cdisplay(0,4,56,_CVT_22(0));
  cdisplay(0,4,71,_CVT_22(0));
  cdisplay(0,5,56,_CVT_22(0));
  cdisplay(0,6,62,_CVT_19(0));
  cdisplay(0,7,62,_CVT_49(0));
  cdisplay(0,8,62,_CVT_49(0));
  cdisplay(0,22,15,_CVT_60(0));
  cdisplay(0,23,15,_CVT_60(0));
  cdisplay(0,24,16,US_5_0_u_0(0));
  cdisplay(0,22,38,HI_LO_text[0]);
  cdisplay(0,23,38,On_Off_text[0]);
  cdisplay(0,24,38,On_Off_text[0]);
  cdisplay(0,25,38,On_Off_text[0]);
  cdisplay(0,26,38,Cl_Op_text[0]);
  cdisplay(0,23,50,_CVT_13(0));
  cdisplay(0,23,63,_CVT_13(0));
  cdisplay(0,24,53,_CVT_13(0));
  cdisplay(0,24,67,_CVT_13(0));
  cdisplay(0,25,57,_CVT_10(0));
  cdisplay(0,25,66,_CVT_10(0));
  cdisplay(0,26,53,_CVT_10(0));
  cdisplay(0,26,58,_CVT_11(0));
  cdisplay(0,26,61,_CVT_11(0));
  cdisplay(0,26,64,_CVT_11(0));
  cdisplay(0,26,67,_CVT_11(0));
  cdisplay(0,26,70,_CVT_11(0));
  cdisplay(1,2,7,_CVT_7(0));
  cdisplay(1,2,14,_CVT_7(0));
  cdisplay(1,3,8,_CVT_5(0));
  cdisplay(1,4,11,_CVT_9(0));
  cdisplay(1,2,28,_CVT_5(0));
  cdisplay(1,3,28,_CVT_5(0));
  cdisplay(1,4,30,SS_6_224_d_0(0));
  cdisplay(1,5,30,SS_6_224_d_0(0));
  cdisplay(1,6,30,SS_6_224_d_0(0));
  cdisplay(1,7,30,SS_6_224_d_0(0));
  cdisplay(1,2,45,_CVT_9(0));
  cdisplay(1,3,45,_CVT_9(0));
  cdisplay(1,4,45,SS_6_224_d_0(0));
  cdisplay(1,6,45,_CVT_3(0));
  cdisplay(1,7,45,_CVT_3(0));
}
...
static void EF1_0(void) {
  ...
  {if (!(V12)) {
    {
    		...
    		if (( home->U0.GC_Ctr_CH1 != ECDOFFLINE ) && ( secondhalf == 1 )) {
  ...
  if ( home->U0.GC_Ctr_CH3 >= 0 )if (!(V13)) {
    {
      	rtg_report( chromCH3_rtg[ chromCH3_rtginc ], ecdCH3x, home->U0.GC_Ctr_CH3 );
    }
  }
  if ( home->U0.GC_Ctr_CH2 >= 0 )if (!(V14)) {
    {
      	rtg_report( chromCH2_rtg[ chromCH2_rtginc ], ecdCH2x, home->U0.GC_Ctr_CH2 );
    }
  }
  if ( home->U0.GC_Ctr_CH1 >= 0 )if (!(V15)) {
    {
...
static void EF8_0(void) {
  ...
  display_(1,2,7, 
   tdlfloas,home->U19.tdl_t,_CVT_7(home->U19.tdl_t));
  display_(1,2,14, 
   tdlfloas,home->U19.tdl_elecT,_CVT_7(home->U19.tdl_elecT));
  display_(1,3,8,
   
   tdlfloa7,tdl_p,_CVT_5(tdl_p));
  display_(1,4,30,
   tdlint6,home->U19.tdl_amp,SS_6_224_d_0(home->U19.tdl_amp));
  display_(1,5,30,
   tdlint6,home->U21.tdl_pow,SS_6_224_d_0(home->U21.tdl_pow));
  display_(1,6,30,
   tdlint6,home->U21.tdl_pos,SS_6_224_d_0(home->U21.tdl_pos));
  display_(1,7,30,
   tdlint6,home->U21.tdl_zer,SS_6_224_d_0(home->U21.tdl_zer));
  display_(1,3,45,
   tdlfloat,tdl_H2OCD,_CVT_9(tdl_H2OCD));
  display_(1,4,45,
   tdlint6,home->U21.tdl_posB,SS_6_224_d_0(home->U21.tdl_posB));
}
...
static void BF16_0(void) {
  ...
  }
  {
    ...
    GC_Freq,ecdA_CH2,_CVT_59(ecdA_CH2));
  }
  if ( DetAvgCt2 > 0 ) {
    ...
    GC_Freq,ecdA_CH1,_CVT_59(ecdA_CH1));
  }
  if ( DetAvgCt3 > 0 ) {
    ...
    GC_Freq,ecdA_CH3,_CVT_59(ecdA_CH3));
  }
  }
  {
  	if (rs485_proxy != 0) 
  ...
  { 
  	MR_CFC12 = MRres( 1 ); {
    display_(0,19,34,
    MixRatio,MR_CFC12,_CVT_1(MR_CFC12));
  }
  }
  { 
  	MR_SF6 = MRres( 2 ); {
  ...
  { 
  	MR_CFC11 = MRres( 4 ); {
    display_(0,20,34,
    MixRatio,MR_CFC11,_CVT_1(MR_CFC11));
  }
  }
}
...
static void BF8_1(void) {
  ...
  display_(1,2,28,
   tdlfloa7,tdl_shortH2O,_CVT_5(tdl_shortH2O));
  display_(1,3,28,
   tdlfloa7,home->U19.tdl_H2OB,_CVT_5(home->U19.tdl_H2OB));
  display_(1,2,45,
...
static void BF16_1(void) {
  BF8_1();
  display_(0,17,8,
   OmegaT,home->U5.CH1_Col,_CVT_16(home->U5.CH1_Col));
}
...
static void BF8_2(void) {
  ...
  if (( home->U23.tdl_best != old_tdl_best ) && (home->U23.tdl_best > 0)) {if (!(V24)) {
    {
      	rtg_report( TDLbest_rtg[ TDLbest_rtginc ], maycX, home->U23.tdl_best );
    }
  }
  }
  display_(1,4,11,
  
   tdlfloat,home->U23.tdl_best,_CVT_9(home->U23.tdl_best));
}

static void BF16_2(void) {
  BF8_2();
  display_(0,17,15,
   OmegaTsp,home->U21.CH1_Col_Sp,_CVT_15(home->U21.CH1_Col_Sp));
  display_(1,6,45, 
   vaifloat,home->U25.vaiT,_CVT_3(home->U25.vaiT));
  display_(1,7,45,
  
   vaifloat,home->U25.vaiRH,_CVT_3(home->U25.vaiRH));
}
...
static void BF16_3(void) {
  ...
  display_(0,10,19,
   ...
   valvetext,home->U15.valv_CH1,Inject_Load_text[home->U15.valv_CH1]);
  display_(0,16,8,
   OmegaT,home->U3.CH1_ECD,_CVT_16(home->U3.CH1_ECD));
  display_(0,10,45,
   valvetext,home->U17.valv_CH2,Inject_Load_text[home->U17.valv_CH2]);
  display_(0,10,70,
   valvetext_inv,home->U17.valv_CH3,Load_Inject_text[home->U17.valv_CH3]);
  display_(0,6,11,
   valvT,home->U17.valv_calSSV,_CVT_14(home->U17.valv_calSSV));
  display_(0,23,50, 
  
  
   o3float,o3x,_CVT_13(o3x));
  display_(0,24,53, 
   o3float,o3xpres,_CVT_13(o3xpres));
  display_(0,24,67, 
   o3float,o3xtemp,_CVT_13(o3xtemp));
  display_(0,25,57, 
...
static void BF16_4(void) {
  ...
  home->U0.CUMSEC++;
  display_(0,13,8,
   SCCMpnu,home->U3.flow_BF1,_CVT_37(home->U3.flow_BF1));
  display_(0,13,15,
   SCCMspPN,home->U1.flow_BF1_sp,_CVT_34(home->U1.flow_BF1_sp));
  display_(0,16,15,
   OmegaTsp,home->U15.CH1_ECD_Sp,_CVT_15(home->U15.CH1_ECD_Sp));
  display_(0,13,35,
   SCCMpnu,home->U1.flow_BF2,_CVT_37(home->U1.flow_BF2));
  display_(0,13,42,
   SCCMspPN,home->U7.flow_BF2_sp,_CVT_34(home->U7.flow_BF2_sp));
  display_(0,22,15,
  
   ULONG,CHROMtime,_CVT_60(CHROMtime));
  display_(0,23,15,
   ULONG,home->U0.CUMSEC,_CVT_60(home->U0.CUMSEC));
}
...
static void BF16_5(void) {
  ...
  display_(0,12,8,
   ...
   SCCMpnu,home->U1.flow_M1,_CVT_37(home->U1.flow_M1));
  display_(0,12,15,
   SCCMspPN,home->U0.flow_M1_sp,_CVT_34(home->U0.flow_M1_sp));
  display_(0,12,35,
  
  
  
   SCCMpnu,home->U0.flow_M2,_CVT_37(home->U0.flow_M2));
  display_(0,12,42,
   SCCMspPN,home->U5.flow_M2_sp,_CVT_34(home->U5.flow_M2_sp));
  display_(0,17,35,
   OmegaT,home->U7.CH2_Col,_CVT_16(home->U7.CH2_Col));
  display_(0,13,60,
   SCCMpnu,home->U7.flow_BF3,_CVT_37(home->U7.flow_BF3));
  display_(0,13,67,
   SCCMspPN,home->U9.flow_BF3_sp,_CVT_34(home->U9.flow_BF3_sp));
}

static void BF16_6(void) {
  O3count = home->U21.O3count;
  ...
  if (!(V6)) {
    {
    	home->U21.o3xbest = 0.970*((o3x-3.0) * o3xpres)/(o3xpres*1.1471 - 244.54) ;
    }
  }
  if (!(V20)) {
    if ( o3xpres > 0 ) {if (!(V21)) {
  ...
  display_(0,17,42,
   OmegaTsp,home->U23.CH2_Col_Sp,_CVT_15(home->U23.CH2_Col_Sp));
  display_(0,12,60,
  
  
  
   SCCMpnu,home->U5.flow_M3,_CVT_37(home->U5.flow_M3));
  display_(0,12,67,
   SCCMspPN,home->U7.flow_M3_sp,_CVT_34(home->U7.flow_M3_sp));
  display_(0,2,12,
   SCCMsl,home->U5.flow_SL,_CVT_31(home->U5.flow_SL));
  display_(0,23,63,
   o3float,home->U21.o3xbest,_CVT_13(home->U21.o3xbest));
}

static void BF16_7(void) {
  EF1_0();
  display_(0,14,8,
   PSIBpnu,home->U1.pres_BP1,_CVT_28(home->U1.pres_BP1));
  display_(0,14,15,
   PSIBspPN,home->U1.pres_BP1_sp,_CVT_25(home->U1.pres_BP1_sp));
  display_(0,15,8,
  
   MBARpnu,home->U1.pres_ECD1,_CVT_46(home->U1.pres_ECD1));
  display_(0,14,35,
   PSIBpnu,home->U7.pres_BP2,_CVT_28(home->U7.pres_BP2));
  display_(0,14,42,
   PSIBspPN,home->U5.pres_BP2_sp,_CVT_25(home->U5.pres_BP2_sp));
  display_(0,16,35,
   OmegaT,home->U9.CH2_ECD,_CVT_16(home->U9.CH2_ECD));
  display_(0,14,60,
  
   PSIBpnu,home->U7.pres_BP3,_CVT_28(home->U7.pres_BP3));
}

static void BF16_9(void) {
  BF8_1();
  display_(0,16,42,
   OmegaTsp,home->U25.CH2_ECD_Sp,_CVT_15(home->U25.CH2_ECD_Sp));
}

static void BF16_10(void) {
  BF8_2();
  display_(0,15,35,
   MBARpnu,home->U3.pres_ECD2,_CVT_46(home->U3.pres_ECD2));
  display_(0,15,60,
   MBARpnu,home->U9.pres_ECD3,_CVT_46(home->U9.pres_ECD3));
  display_(0,17,60,
   OmegaT,home->U1.CH3_Col,_CVT_16(home->U1.CH3_Col));
}

static void BF16_11(void) {
  EF1_0();
  display_(0,17,67,
   OmegaTsp,home->U13.CH3_Col_Sp,_CVT_15(home->U13.CH3_Col_Sp));
  display_(0,3,12,
   ...
   MBARpnuSL,home->U11.pres_SL,_CVT_43(home->U11.pres_SL));
  display_(0,4,56,
   PSIL,home->U9.presL_cal,_CVT_22(home->U9.presL_cal));
  display_(0,4,71,
   PSIL,home->U11.presL_dope,_CVT_22(home->U11.presL_dope));
  display_(0,6,62,
   PSIH,home->U9.presH_123,_CVT_19(home->U9.presH_123));
  display_(0,7,62,
   MBAR,home->U9.pres_extern,_CVT_49(home->U9.pres_extern));
  display_(0,8,62,
   MBAR,home->U5.pres_PUMP,_CVT_49(home->U5.pres_PUMP));
}
...
static void BF16_12(void) {
  ...
  display_(0,16,60,
   ...
   OmegaT,home->U0.CH3_ECD,_CVT_16(home->U0.CH3_ECD));
  display_(0,2,37,
  
   CELS,home->U3.temp_amb,_CVT_40(home->U3.temp_amb));
  display_(0,3,37,
   CELS,home->U5.temp_pump,_CVT_40(home->U5.temp_pump));
  display_(0,4,37,
   CELS,home->U3.temp_gasB_N,_CVT_40(home->U3.temp_gasB_N));
  display_(0,5,37,
   CELS,home->U9.temp_gasB_C,_CVT_40(home->U9.temp_gasB_C));
  display_(0,6,37,
   CELS,home->U3.temp_SL1,_CVT_40(home->U3.temp_SL1));
  display_(0,5,56,
   PSIL,home->U11.presL_N2,_CVT_22(home->U11.presL_N2));
}
...
static void BF16_13(void) {
  ...
  display_(0,18,8,
   VOLTS512,home->U7.volt_1234,_CVT_58(home->U7.volt_1234));
  display_(0,16,67,
  
   OmegaTsp,home->U11.CH3_ECD_Sp,_CVT_15(home->U11.CH3_ECD_Sp));
  display_(0,7,37,
   CELS,home->U3.temp_SL2,_CVT_40(home->U3.temp_SL2));
  display_(0,8,37,
   CELS,home->U11.temp_SL3,_CVT_40(home->U11.temp_SL3));
  display_(0,2,62,
   VOLTSPM,home->U11.volt_15,_CVT_55(home->U11.volt_15));
  display_(0,3,62,
   VOLTS28,home->U13.volt_28,_CVT_52(home->U13.volt_28));
}
...
static void BF16_14(void) {
  ...
  display_(0,18,60,
   OmegaT,home->U13.CH3_Post,_CVT_16(home->U13.CH3_Post));
  display_(0,18,67,
   OmegaTsp,home->U13.CH3_Post_Sp,_CVT_15(home->U13.CH3_Post_Sp));
  display_(0,7,11,
   Bit_Cl_Op,home->U0.N2_IN,Cl_Op_text[home->U0.N2_IN]);
  display_(0,1,62,
   VOLTS512,home->U13.volt_5,_CVT_58(home->U13.volt_5));
  display_(0,24,16,
   UINT,home->U0.CurrInj,US_5_0_u_0(home->U0.CurrInj));
  display_(0,22,38,
  
  
   Bit_HI_LO,home->U15.ManSwitch,HI_LO_text[home->U15.ManSwitch]);
  display_(0,24,38,
  
  
   Bit_On_Off,home->U33.O3Pump,On_Off_text[home->U33.O3Pump]);
  display_(0,25,38,
   Bit_On_Off,home->U13.H2OPump,On_Off_text[home->U13.H2OPump]);
  display_(0,26,38,
   Bit_Cl_Op,home->U15.H2OValve,Cl_Op_text[home->U15.H2OValve]);
}
...
static void EF16_15(void) {
  ...
  display_(0,1,20,
   ...
   Bit_Air_Cal,home->U15.ssv,Air_Cal_text[home->U15.ssv]);
  display_(0,4,6,
   Bit_Cl_Op,home->U11.SLoopIN,Cl_Op_text[home->U11.SLoopIN]);
  display_(0,4,18,
   Bit_Op_Cl,home->U13.SLoopOUT,Op_Cl_text[home->U13.SLoopOUT]);
  display_(0,23,38,
  
   Bit_On_Off,home->U13.PumpSwitch,On_Off_text[home->U13.PumpSwitch]);
  display_(0,26,53, 
   o3int4,home->U15.o3xyy,_CVT_10(home->U15.o3xyy));
  display_(0,26,58, 
   o3int,home->U17.o3xmm,_CVT_11(home->U17.o3xmm));
  display_(0,26,61, 
   o3int,home->U17.o3xdd,_CVT_11(home->U17.o3xdd));
  display_(0,26,64, 
   o3int,home->U17.o3xhh,_CVT_11(home->U17.o3xhh));
  display_(0,26,67,
   o3int,home->U17.o3xmin,_CVT_11(home->U17.o3xmin));
  display_(0,26,70,
   o3int,home->U15.o3xss,_CVT_11(home->U15.o3xss));
}
...
static void BF128_79(void) {
  ...
  if (!(V16)) {
    if ( o3pres > 0 ) {if (!(V17)) {
      {
        	rtg_report( ozoneConc_rtg[ ozoneConc_rtginc ], O3count, home->U17.o3 );
      }
    }if (!(V18)) {
      {
      ...
      {
        	rtg_report( ozoneTemp_rtg[ ozoneTemp_rtginc ], O3count, o3temp );
      }
    }
    }
  }

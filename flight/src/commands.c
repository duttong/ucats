...
void SetFlowPN( unsigned int board, unsigned int ch, float setpoint ) {
	...
	// convert flow setpoint to volts (0 to 5V scale) for Pneucleus controllers
	volts = 5.00/200.0 * setpoint;
...
void SetPressBF( unsigned int board, unsigned int ch, float setpoint ) {
	...
	// convert BFpress setpoint to volts (0 to 5V scale)
	volts = 5.0/100.0 * setpoint;

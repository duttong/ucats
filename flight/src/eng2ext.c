...
RHstruct vai;
 ...
 typedef float vaifloat; /* edf2ext.awk reading eng2.edf */
  #include <stdlib.h>
  #include "ssp.h"
  #include "tmctime.h"
...
static void BF16_3(void) {
  valv_calSSV = home->U17.valv_calSSV;
  o3x = home->U15.o3x;
  ...
  if (!(V10)) {
    {
      ...
      ss_set(eng2, 1, _CVT_3(temp_pump));
      ss_set(eng2, 2, _CVT_3(temp_SL2));
      ss_set(eng2, 3, _CVT_2(pres_BP2));
      ss_set(eng2, 4, _CVT_2(pres_BP3));
      ss_set(eng2, 5, _CVT_4(pres_ECD1));
      ss_set(eng2, 6, _CVT_3(temp_amb));
      ss_set(eng2, 7, _CVT_5(pres_extern));
      ss_set(eng2, 8, _CVT_8(volt_1234));
      ss_set(eng2, 9, _CVT_1(presL_dope));
      ss_set(eng2, 10, _CVT_1(presL_cal));
      ss_set(eng2, 11, _CVT_1(presL_N2));
      ss_set(eng2, 12, _CVT_0(presH_123));
      ss_set(eng2, 13, _CVT_8(volt_5));
      ss_set(eng2, 14, _CVT_7(volt_15));
      ss_set(eng2, 15, _CVT_6(volt_28));
      ss_set(eng2, 16, (CH1_ECD*1E-1));
      ss_set(eng2, 17, (CH1_Col*1E-1));
      ss_set(eng2, 18, (CH2_ECD*1E-1));
      ss_set(eng2, 19, (CH2_Col*1E-1));
      ss_set(eng2, 20, (CH3_ECD*1E-1));
      ss_set(eng2, 21, (CH3_Col*1E-1));
      ss_set(eng2, 22, (CH3_Post*1E-1));
      ss_set(eng2, 23, home->U0.GCstate);
      ss_set(eng2, 24, home->U15.ssv);
      ss_set(eng2, 25, valv_calSSV);
    }
  }
}

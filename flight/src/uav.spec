...
uavalgo : integrate.c int.tmc intdsp.tmc reveal.c nasdat.c kusend.c commands.c uav.tma
#dc8algo : integrate.c int.tmc intdsp.tmc reveal.c nasdat.c kusend.c dc8.tma
labalgo : integrate.c int.tmc intdsp.tmc reveal.c nasdat.c kusend.c commands.c lab.tma
...
dc8doit : main.fld h2o.fld normal.cfg

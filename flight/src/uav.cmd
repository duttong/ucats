...
#	: Power &On { ADRdigSet( 0, 1, $2 ); }
	: Pump GC &On { ADRdigSet( 1, 2, $3 ); }
	: Pump Ozone &On { ADRdigSet( 3, 7, $3 ); }
	: Pump H2O &On { ADRdigSet( 3, 6, $3 ); }
	: Valve H2O &Open { ADRdigSet( 3, 5, $3 ); }
	: Pump All &On { ADRdigSet( 1, 2, $3 ); ADRdigSet( 3, 7, $3 ); ADRdigSet( 3, 6, $3 ); ADRdigSet( 3, 5, $3 ); }

#	: Ozone &On { ADRdigSet( 0, 3, $2 ); }

	: Nitrogen &Open { ADRdigSet( 0, 5, $2 ); }

	: sample air { ADRdigSet( 1, 4, 0 ); }
	: sample cal { ADRdigSet( 1, 4, 1 ); }

	: solenoid samp In &Open { ADRdigSet( 1, 6, $4 ); }
	: solenoid samp Out &Open2 { ADRdigSet( 1, 7, $4 ); }
	: solenoid samp both Open {	ADRdigSet( 1, 6, 1 ); ADRdigSet( 1, 7, 0 ); } 
	: solenoid samp both Close { ADRdigSet( 1, 6, 0 ); ADRdigSet( 1, 7, 1 ); } 
	...
	: flow main channel 1 &FlowSetpoint { SetFlowPN( 1, 0, $5 ); }
	: flow main channel 2 &FlowSetpoint { SetFlowPN( 2, 0, $5 ); }
	: flow main channel 3 &FlowSetpoint { SetFlowPN( 3, 0, $5 ); }
	: flow backflush channel 1 &FlowSetpoint { SetFlowPN( 1, 1, $5 ); }
	: flow backflush channel 2 &FlowSetpoint { SetFlowPN( 2, 1, $5 ); }
	: flow backflush channel 3 &FlowSetpoint { SetFlowPN( 3, 1, $5 ); }

	: press backflush channel 1 setpoint &PressSetpointBF { SetPressBF( 0, 0, $6 ); }
	: press backflush channel 2 setpoint &PressSetpointBF { SetPressBF( 0, 1, $6 ); }
...
&GSVADDRESS <unsigned short>
	...
	: channel 3 &GSVVALVEPOS_Inv { switch_gsv( CH3gsvADD, $3 ); }
	;

...
RHstruct vai;
 ...
 typedef float vaifloat; /* edf2ext.awk reading eng1.edf */
  #include <stdlib.h>
  #include "ssp.h"
  #include "tmctime.h"
  ...
  void initialize(void) {
	...
	ss_set_column(eng1, 19, "%12.1f", "flow_M3");
	ss_set_column(eng1, 20, "%12.1f", "flow_M3_sp");
	ss_set_column(eng1, 21, "%12.1f", "flow_BF3");
	ss_set_column(eng1, 22, "%12.1f", "flow_BF3_sp");
	ss_set_column(eng1, 23, "%12.1f", "pres_ECD3");
	ss_set_column(eng1, 24, "%12.1f", "temp_SL3");
	ss_set_column(eng1, 25, "%12.1f", "ecdA_CH1");
	ss_set_column(eng1, 26, "%12.1f", "ecdA_CH2");
	ss_set_column(eng1, 27, "%12.1f", "ecdA_CH3");
  }
  void terminate(void) {
	ss_close(eng1);
  }
...
static void BF16_4(void) {
  flow_BF2_sp = home->U7.flow_BF2_sp;
...
static void BF16_5(void) {
  ...
  flow_BF3_sp = home->U9.flow_BF3_sp;
...
static void BF16_7(void) {
  ...
  pres_BP1_sp = home->U1.pres_BP1_sp;
  ...
  if (!(V10)) {
    {
      ...
      ss_set(eng1, 1, _CVT_4(flow_M1));
      ss_set(eng1, 2, _CVT_3(flow_M1_sp));
      ss_set(eng1, 3, _CVT_4(flow_BF1));
      ss_set(eng1, 4, _CVT_3(flow_BF1_sp));
      ss_set(eng1, 5, _CVT_1(pres_BP1));
      ss_set(eng1, 6, _CVT_0(pres_BP1_sp));
      ss_set(eng1, 7, _CVT_6(pres_SL));
      ss_set(eng1, 8, _CVT_5(temp_gasB_N));
      ss_set(eng1, 9, _CVT_5(temp_SL1));
      ss_set(eng1, 10, _CVT_5(temp_gasB_C));
      ss_set(eng1, 11, _CVT_2(flow_SL));
      ss_set(eng1, 12, _CVT_4(flow_M2));
      ss_set(eng1, 13, _CVT_3(flow_M2_sp));
      ss_set(eng1, 14, _CVT_4(flow_BF2));
      ss_set(eng1, 15, _CVT_3(flow_BF2_sp));
      ss_set(eng1, 16, _CVT_8(pres_PUMP));
      ss_set(eng1, 17, _CVT_0(pres_BP2_sp));
      ss_set(eng1, 18, _CVT_7(pres_ECD2));
      ss_set(eng1, 19, _CVT_4(flow_M3));
      ss_set(eng1, 20, _CVT_3(flow_M3_sp));
      ss_set(eng1, 21, _CVT_4(flow_BF3));
      ss_set(eng1, 22, _CVT_3(flow_BF3_sp));
      ss_set(eng1, 23, _CVT_7(pres_ECD3));
      ss_set(eng1, 24, _CVT_5(home->U11.temp_SL3));
      ss_set(eng1, 25, ecdA_CH1);
      ss_set(eng1, 26, ecdA_CH2);
      ss_set(eng1, 27, ecdA_CH3);
    }
  }
}

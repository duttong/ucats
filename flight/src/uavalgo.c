...
unsigned char V25 = 0x1;
unsigned char V26 = 0x3;
unsigned char V27 = 0x1;
unsigned char V28 = 0x1;
unsigned char V29 = 0x1;
unsigned char V30 = 0x1;
unsigned char V31 = 0x7F;
unsigned int V32 = 0xFFFF;
unsigned char V33 = 0xF;
unsigned char V34 = 0x1;
unsigned char V35 = 0x1;
ULONG CHROMtime;
SCCMpnu flow_M1;
SCCMpnu flow_BF1;
PSIBpnu pres_BP1;
...
static void VSET_19_(unsigned short newstate) {
...
static void VSET_18_(unsigned short newstate) {
  static unsigned short oldstate;
...
static void VSET_14_(unsigned short newstate) {
  ...
  switch (oldstate) {
    case 5: /* O3PumpON_end_ */
      V25 |= 0x1;
      break;
    case 4: /* O3PumpON_1_ */
      V24 |= 0x1;
      break;
    case 3: /* O3PumpOff_end_ */
      V23 |= 0x1;
      break;
    case 2: /* O3PumpOff_1_ */
      V22 |= 0x1;
...
static void VSET_13_(unsigned short newstate) {
  ...
  switch (oldstate) {
    case 8: /* PumpON_PressCheck_end_ */
      V20 |= 0x1;
      break;
    case 6: /* InletPumpON_1_ */
      V19 |= 0x1;
      break;
    case 5: /* InletPumpOff_end_ */
      V18 |= 0x1;
      break;
    case 4: /* InletPumpOff_1_ */
      V17 |= 0x1;
      break;
    case 3: /* CalInjections_end_ */
      V16 |= 0x1;
      break;
    case 2: /* CalInjections_1_ */
      V15 |= 0x1;
      break;
  }
  oldstate = newstate;
...
static void VSET_12_(unsigned short newstate) {
  ...
  switch (newstate) {
    case 2: /* Shutdown */ {
        {
          tma_init_state( 6, Shutdown_cmds_, "Shutdown" ); VSET_19_(1);
        }
      }
      break;
    case 1: /* ShutdownComputer */ {
        {
          tma_init_state( 6, ShutdownComputer_cmds_, "ShutdownComputer" ); VSET_19_(1);
        }
      }
      break;
  }
...
static void VSET_11_(unsigned short newstate) {
  ...
  switch (newstate) {
    case 1: /* FailBoard_Toggle */ {
        V34 &= ~0x1;
        {
          tma_init_state( 5, FailBoard_Toggle_cmds_, "FailBoard_Toggle" ); VSET_18_(1);
        }
      }
      break;
  }
...
static void VSET_10_(unsigned short newstate) {
  ...
  switch (newstate) {
    case 1: /* KUDATA_eng */ {
        V32 &= ~0x1;
        {
          tma_init_state( 4, KUDATA_eng_cmds_, "KUDATA_eng" ); VSET_17_(1);
        }
      }
      break;
  }
...
static void VSET_9_(unsigned short newstate) {
  ...
  switch (newstate) {
    case 1: /* NASDAT_eng */ {
        V31 &= ~0x1;
        {
          tma_init_state( 3, NASDAT_eng_cmds_, "NASDAT_eng" ); VSET_16_(1);
        }
      }
      break;
  }
...
static void VSET_8_(unsigned short newstate) {
  ...
  switch (newstate) {
    case 5: /* CALnext */ {
        {
          tma_init_state( 2, CALnext_cmds_, "CALnext" ); VSET_15_(1);
        }
      }
      break;
    case 4: /* AIRnext */ {
        {
          tma_init_state( 2, AIRnext_cmds_, "AIRnext" ); VSET_15_(1);
        }
      }
      break;
    case 3: /* SSVtable */ {
        V27 &= ~0x1;
        {
          tma_init_state( 2, SSVtable_cmds_, "SSVtable" ); VSET_15_(1);
        }
      }
      break;
    case 2: /* SSVtableInit */ {
        V26 &= ~0x2;
        {
          tma_init_state( 2, SSVtableInit_cmds_, "SSVtableInit" ); VSET_15_(1);
        }if (!(V26)) {
          { VSET_8_(3);
          	}
        }
    ...
    case 1: /* Idle */ {
        {
          tma_init_state( 2, Idle_cmds_, "Idle" ); VSET_15_(1);
        }
      }
      break;
  }
...
static void VSET_7_(unsigned short newstate) {
  ...
  switch (newstate) {
    case 3: /* O3PumpON */ {
        {
          tma_init_state( 1, O3PumpON_cmds_, "O3PumpON" ); VSET_14_(1);
        }
      }
      break;
    case 2: /* O3PumpOff */ {
        {
          tma_init_state( 1, O3PumpOff_cmds_, "O3PumpOff" ); VSET_14_(1);
        }
      }
      break;
    case 1: /* O3AltCheck */ {
        V21 &= ~0x1;
        {
          tma_init_state( 1, O3AltCheck_cmds_, "O3AltCheck" ); VSET_14_(1);
        }
      }
      break;
  }
...
static void VSET_6_(unsigned short newstate) {
  ...
  oldstate = newstate;
  switch (newstate) {
    case 7: /* PumpON_PressCheck */ {
        {
          tma_init_state( 0, PumpON_PressCheck_cmds_, "PumpON_PressCheck" ); VSET_13_(1);
        }
      }
      break;
    case 6: /* InletPumpON */ {
        {
          tma_init_state( 0, InletPumpON_cmds_, "InletPumpON" ); VSET_13_(1);
        }
      }
      break;
    case 5: /* InletPumpOff */ {
        {
          tma_init_state( 0, InletPumpOff_cmds_, "InletPumpOff" ); VSET_13_(1);
        }
      }
      break;
    case 4: /* CalInjections */ {
        {
          tma_init_state( 0, CalInjections_cmds_, "CalInjections" ); VSET_13_(1);
        }
      }
      break;
    case 3: /* AltCheck */ {
        V14 &= ~0x1;
        {
          tma_init_state( 0, AltCheck_cmds_, "AltCheck" ); VSET_13_(1);
        }
      }
      break;
    case 2: /* Warmup */ {
        V13 &= ~0x1;
        {
          tma_init_state( 0, Warmup_cmds_, "Warmup" ); VSET_13_(1);
        }
      }
      break;
    case 1: /* initialize */ {
        {
          tma_init_state( 0, initialize_cmds_, "initialize" ); VSET_13_(1);
        }
      }
      break;
  }
...
static void tminitfunc(void) {VSET_0_(1);VSET_1_(1);VSET_2_(1);VSET_3_(1);VSET_4_(1);VSET_5_(1);VSET_6_(1);VSET_7_(1);VSET_8_(1);VSET_9_(1);VSET_10_(1);VSET_11_(1);VSET_12_(1);VSET_13_(1);VSET_14_(1);VSET_15_(1);VSET_16_(1);VSET_17_(1);VSET_18_(1);VSET_19_(1);
}
...
static void BF16_0(void) {
  ...
  if (!(V27)) {
    {if (!(V28)) {
      { 
      			if ( CalCount < NUMCALINJ ) VSET_8_(5);
      			else VSET_8_(4);
      		}
    }if (!(V29)) {
      { 
  ...
  }
  {
    ...
    while ( subcase = tma_process( it ) ) {
  	switch (subcase) {
  	  ...
  	  case 4: VSET_6_(4); break;
  	  case 5: VSET_6_(5); break;
  	  case 6: VSET_6_(6); break;
  	  case 7: VSET_6_(7); break;
  	  case 8: VSET_7_(1); break;
  	  case 9: VSET_7_(2); break;
  	  case 10: VSET_7_(3); break;
  	  case 11: VSET_8_(1); break;
  	  case 12: VSET_8_(2); break;
  	  case 13: VSET_8_(3); break;
  	  case 14: VSET_8_(4); break;
  	  case 15: VSET_8_(5); break;
  	  case 16: VSET_9_(1); break;
  	  case 17: VSET_10_(1); break;
  	  case 18: VSET_11_(1); break;
  	  case 19: VSET_12_(1); break;
  	  case 20: VSET_12_(2); break;
  	  case 21: VSET_13_(1); break;
  	  case 22: VSET_13_(2); break;
  	  case 23: VSET_13_(3); break;
  	  case 24: VSET_13_(4); break;
  	  case 25: VSET_13_(5); break;
  	  case 26: VSET_13_(6); break;
  	  case 27: VSET_13_(7); break;
  	  case 28: VSET_13_(8); break;
  	  case 29: VSET_14_(1); break;
  	  case 30: VSET_14_(2); break;
  	  case 31: VSET_14_(3); break;
  	  case 32: VSET_14_(4); break;
  	  case 33: VSET_14_(5); break;
  	  case 34: VSET_15_(1); break;
  	  case 35: VSET_15_(2); break;
  	  case 36: VSET_15_(3); break;
  	  case 37: VSET_16_(1); break;
  	  case 38: VSET_17_(1); break;
  	  case 39: VSET_18_(1); break;
  	  case 40: VSET_19_(1); break;
  	  case 41: VSET_19_(2); break;
  	  default:
...
static void BF16_11(void) {
  ...
  EF1_0();
  if (!(V14)) {
    { if ((( _CVT_8(pres_PUMP) < PumpON ) && ( _CVT_8(pres_PUMP) > 0 )) || (( _CVT_8(pres_extern) < PumpON ) && ( _CVT_8(pres_extern) > 0 ))) VSET_6_(6);
    	  else VSET_6_(4);
    	}
  }
  if (!(V15)) {
    V15 |= 0x1;
    { msg( 0, "Starting Cal Seq. (pres_extern = %6.1f)", _CVT_8(pres_extern) ); }
  }
  if (!(V16)) {
    { if ((( _CVT_8(pres_PUMP) < PumpON ) && ( _CVT_8(pres_PUMP) > 0 )) || (( _CVT_8(pres_extern) < PumpON ) && ( _CVT_8(pres_extern) > 0 ))) VSET_6_(6);
    		}
  ...
  if (!(V17)) {
    V17 |= 0x1;
    { msg( 0, "Turning GC Pump OFF (pres_extern = %6.1f)", _CVT_8(pres_extern) ); }
  }
  if (!(V18)) {
    { if ((( _CVT_8(pres_PUMP) < PumpON ) && ( _CVT_8(pres_PUMP) > 0 )) || (( _CVT_8(pres_extern) < PumpON ) && ( _CVT_8(pres_extern) > 0 ))) VSET_6_(6);
    		}
  ...
  if (!(V19)) {
    V19 |= 0x1;
    { msg( 0, "Turning Pumps ON (pres_extern = %6.1f)", _CVT_8(pres_extern) ); 
    		AirCount = 0;
    		CalCount = 0; }
  }
  if (!(V20)) {
    { if ( _CVT_8(pres_extern) >= PumpOFF ) {
                msg( 0, "Press Extern High Pump Trigger (pres_extern = %6.1f)",_CVT_8(pres_extern));
                EXT_PRES_INC += 1;
                if (EXT_PRES_INC >= 4) { VSET_6_(5);
                }
              }  else {
                EXT_PRES_INC = 0;
              }
  ...
  if (!(V21)) {
    { if ((( _CVT_8(pres_PUMP) < PumpO3ON ) && ( _CVT_8(pres_PUMP) > 0 )) || (( _CVT_8(pres_extern) < PumpO3ON ) && ( _CVT_8(pres_extern) > 0 ))) VSET_7_(3);
    	}
  }
  if (!(V22)) {
    V22 |= 0x1;
    { msg( 0, "Turning O3 Pump OFF (pres_extern = %6.1f)", _CVT_8(pres_extern) ); }
  }
  if (!(V23)) {
    { if ((( _CVT_8(pres_PUMP) < PumpO3ON ) && ( _CVT_8(pres_PUMP) > 0 )) || (( _CVT_8(pres_extern) < PumpO3ON ) && ( _CVT_8(pres_extern) > 0 ))) VSET_7_(3);
    		}
  ...
  if (!(V24)) {
    V24 |= 0x1;
    { msg( 0, "Turning O3 Pump ON (pres_extern = %6.1f)", _CVT_8(pres_extern) ); }
  }
  if (!(V25)) {
    { if ( _CVT_8(pres_extern) >= PumpO3OFF ) VSET_7_(2);
    		}
  }
}
...
static void BF16_12(void) {
  ...
  EF1_0();
  if (!(V13)) {
    { if (( CH2_ECD/10 > HOT_ECD2 ) || ( CH3_ECD/10 > HOT_ECD1 )) VSET_6_(3);
    	}
  }
  if (!(V31)) {
    {	
...
static void BF16_14(void) {
  ...
  if (!(V35)) {
    { if ( home->U13.InitShutdown == FALSE ) VSET_12_(2); }
  }
}
...
static void EF16_15(void) {
  ...
  if (!(V33||V32)) {
    {	
    		...
    		KUformat_f(kuMSG, "pres_BP3=%6.1f",_CVT_2(pres_BP3), 		0);
    		...
    		KUformat_f(kuMSG, "temp_gasB_N=%6.1f",_CVT_5(temp_gasB_N), -30);
    		KUformat_f(kuMSG, "temp_gasB_C=%6.1f",_CVT_5(temp_gasB_C), -30);
    		KUformat_f(kuMSG, "temp_pump=%6.1f",_CVT_5(temp_pump),	  -30);
    		KUformat_f(kuMSG, "temp_amb=%6.1f",_CVT_5(temp_amb), 	  -30);
    		...
    		KUformat_d(kuMSG, "GCstate=%02d", 		home->U0.GCstate, 			   -1);
    		KUformat_d(kuMSG, "ssv=%d", 			home->U15.ssv, 				   -2);

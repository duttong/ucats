...
static void EF1_0(void) {
  ...
  }
  {
  	...
  	if ( (home->U0.GC_Ctr_CH1 == ECDOFFLINE) && (home->U0.GC_Ctr_CH2 == ECDOFFLINE) && (home->U0.GC_Ctr_CH3 == ECDOFFLINE) ){ }
  	else {
  		itx_ctr_dataL( home->U0.GC_Ctr_CH1 );
  		itx_ctr_dataL( home->U0.GC_Ctr_CH2 );
  		itx_ctr_dataL( home->U0.GC_Ctr_CH3 );
  		itx_text_data( "\n" );
  	}
...
static void BF16_14(void) {
  CurrInj = home->U0.CurrInj;
  CurrFile = home->U0.CurrFile;
  V11 &= ~0x1;
  EF1_0();
...
static void EF16_15(void) {
  ...
  if (!(V10)) {
    {
    	old_ssv = home->U15.ssv;
    	old_calssv = valv_calSSV;
    	old_pres_SL = _CVT_1(pres_SL);
    	old_temp_SL1 = _CVT_0(temp_SL1);
    	old_temp_SL2 = _CVT_0(temp_SL2);
    	old_temp_SL3 = _CVT_0(temp_SL3);
    }
  }
  if (!(V11)) {
    if ((home->U0.GCstate == 1) || (home->U0.GCstate == 3)) {

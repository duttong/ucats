...
unsigned char V13 = 0x7F;
unsigned int V14 = 0xFFFF;
unsigned char V15 = 0xF;
...
static void VSET_9_(unsigned short newstate) {
  ...
  switch (newstate) {
    case 1: /* FailBoard_Toggle */ {
        V16 &= ~0x1;
        {
          tma_init_state( 3, FailBoard_Toggle_cmds_, "FailBoard_Toggle" ); VSET_14_(1);
        }
      }
      break;
  }
...
static void VSET_8_(unsigned short newstate) {
  ...
  switch (newstate) {
    case 1: /* KUDATA_eng */ {
        V14 &= ~0x1;
        {
          tma_init_state( 2, KUDATA_eng_cmds_, "KUDATA_eng" ); VSET_13_(1);
        }
      }
      break;
  }
...
static void VSET_7_(unsigned short newstate) {
  ...
  switch (newstate) {
    case 1: /* NASDAT_eng */ {
        V13 &= ~0x1;
        {
          tma_init_state( 1, NASDAT_eng_cmds_, "NASDAT_eng" ); VSET_12_(1);
        }
      }
      break;
  }
  ...
  }
  {
    ...
    while ( subcase = tma_process( it ) ) {
  	switch (subcase) {
  	  ...
  	  case 3: VSET_8_(1); break;
  	  case 4: VSET_9_(1); break;
  	  case 5: VSET_10_(1); break;
  	  case 6: VSET_10_(2); break;
  	  case 7: VSET_11_(1); break;
  	  case 8: VSET_12_(1); break;
  	  case 9: VSET_13_(1); break;
  	  case 10: VSET_14_(1); break;
  	  case 11: VSET_15_(1); break;
  	  case 12: VSET_15_(2); break;
  	  default:

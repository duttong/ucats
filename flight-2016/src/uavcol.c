...
static void BF8_0(void) {
  ...
  home->U29.tdl_p = tdl_p;
  home->U29.tdl_t = tdl_t;
  home->U29.tdl_elecT = tdl_elecT;
  home->U19.tdl_amp = tdl_amp;
  home->U19.tdl_pow = tdl_pow;
  home->U24.tdl_pos = tdl_pos;
  home->U24.tdl_zer = tdl_zer;
  home->U24.tdl_posB = tdl_posB;
  EF1_0();
  {
...
static void BF8_1(void) {
  CF1_0();
  memcpy(home->U26.U28, &tdlrec, 2);
  home->U26.tdl_time = tdl_time;
  home->U26.tdl_shortH2O = tdl_shortH2O;
  home->U17.tdl_H2OB = tdl_H2OB;
  home->U22.tdl_longH2O = tdl_longH2O;
  home->U22.tdl_H2OCD = tdl_H2OCD;
  EF1_0();
}

static void CF8_2(void) {
  CF1_0();
  memcpy(home->U19.U21, ((char*)(&tdlrec))+2, 2);
  home->U24.tdl_best = tdl_best;
  home->U19.maycX = maycX;
}
...
static void BF16_2(void) {
  ...
  home->U31.vaiRH = vaiRH;
  home->U31.vaiT = vaiT;
  home->U1.CHROMtime = CHROMtime;
  EF8_2();
}
...
static void BF16_3(void) {
  ...
  home->U17.valv_CH1 = valv_CH1;
  home->U17.valv_CH2 = valv_CH2;
  home->U19.valv_calSSV = valv_calSSV;
  home->U22.o3x = o3x;
  home->U13.o3xtemp = o3xtemp;
  home->U17.o3xpres = o3xpres;
...
static void BF16_4(void) {
  ...
  home->U9.flow_BF2_sp = flow_BF2_sp;
  home->U7.flow_BF2 = flow_BF2;
  home->U1.flow_BF1_sp = flow_BF1_sp;
  home->U1.flow_BF1 = flow_BF1;
...
static void BF16_5(void) {
  ...
  home->U13.CH1_Col_Sp = CH1_Col_Sp;
  home->U7.flow_SL = flow_SL;
  home->U5.flow_M2_sp = flow_M2_sp;
  home->U5.flow_M2 = flow_M2;
...
static void BF16_6(void) {
  CF1_0();
  CH1_ECD = OmegaArray( 2 * 0x4 - 2 );
  pres_BP1_sp = ADRdtoa(0x0);
  pres_BP1 = ADRanalog(0xC);
  home->U3.CH1_ECD = CH1_ECD;
  home->U3.pres_BP1_sp = pres_BP1_sp;
  home->U1.pres_BP1 = pres_BP1;
  home->U15.o3xbest = o3xbest;
  home->U15.O3count = O3count;
  ...
  {
  	o3xbest = 0.927*((o3x-3.0) * o3xpres)/(o3xpres*1.00095 + 3.23) ;
  }
}

static void BF16_7(void) {
  CF1_0();
  CH1_ECD_Sp = OmegaArray( 2 * 0x4 - 1 );
  pres_extern = ADRanalog(0x1B);
  pres_ECD2 = ADRanalog(0x17);
  pres_BP2_sp = ADRdtoa(0x1);
  pres_PUMP = ADRanalog(0x16);
  pres_SL = ADRanalog(0xD);
  home->U11.CH1_ECD_Sp = CH1_ECD_Sp;
  home->U5.pres_SL = pres_SL;
  home->U9.pres_PUMP = pres_PUMP;
  home->U7.pres_extern = pres_extern;
...
static void BF16_10(void) {
  ...
  presL_cal = ADRanalog(0x2);
  presL_dope = ADRanalog(0x1);
  home->U15.presL_dope = presL_dope;
  home->U0.presL_cal = presL_cal;
  home->U0.presH_123 = presH_123;
  EF8_2();
}

static void BF16_11(void) {
  CF1_0();
  CH2_Col = OmegaArray( 2 * 0x2 - 2 );
  presL_N2 = ADRanalog(0x3);
  temp_amb = ADRanalog(0x10);
  temp_pump = ADRanalog(0x18);
  temp_gasB_C = ADRanalog(0x1A);
  temp_gasB_N = ADRanalog(0xE);
  home->U0.CH2_Col = CH2_Col;
  home->U11.temp_pump = temp_pump;
  home->U3.temp_gasB_N = temp_gasB_N;
  home->U3.temp_gasB_C = temp_gasB_C;
  home->U7.temp_amb = temp_amb;
  home->U7.presL_N2 = presL_N2;
  EF1_0();
}

static void BF16_12(void) {
  CF1_0();
  CH2_Col_Sp = OmegaArray( 2 * 0x2 - 1 );
  volt_15 = ADRanalog(0x6);
  volt_1234 = ADRanalog(0x0);
  temp_SL2 = ADRanalog(0x19);
  temp_SL1 = ADRanalog(0xF);
  home->U9.CH2_Col_Sp = CH2_Col_Sp;
  home->U13.volt_15 = volt_15;
  home->U13.volt_1234 = volt_1234;
  home->U22.vaisX = vaisX;
  home->U5.temp_SL2 = temp_SL2;
...
static void BF16_13(void) {
  CF1_0();
  CH2_Post_Sp = OmegaArray( 2 * 0x3 - 1 );
  CH2_ECD_Sp = OmegaArray( 2 * 0x1 - 1 );
  H2O_Pelt = OmegaArray( 2 * 0x6 - 2 );
  CH2_Post = OmegaArray( 2 * 0x3 - 2 );
  CH2_ECD = OmegaArray( 2 * 0x1 - 2 );
  volt_28 = ADRanalog(0x7);
  volt_5 = ADRanalog(0x5);
  CurrFile = CurrFile_;
  CurrInj = CurrInj_;
  home->U7.H2O_Pelt = H2O_Pelt;
  home->U0.CurrInj = CurrInj;
  home->U1.CurrFile = CurrFile;
  home->U11.CH2_Post_Sp = CH2_Post_Sp;
  home->U15.CH2_Post = CH2_Post;
  home->U9.CH2_ECD_Sp = CH2_ECD_Sp;
  home->U9.CH2_ECD = CH2_ECD;
  home->U9.volt_5 = volt_5;
  home->U9.volt_28 = volt_28;
  EF1_0();
...
static void BF16_14(void) {
  CF1_0();
  N2_IN = ADRdig(0x4);
  KeySwitch = ADRdig(0x3);
  ManSwitch = ADRdig(0x1);
  InitShutdown = ADRdig(0x0);
  H2O_Pelt_Sp = OmegaArray( 2 * 0x6 - 1 );
  home->U24.o3xyy = o3xyy;
  home->U24.o3xss = o3xss;
  home->U24.o3xmm = o3xmm;
  home->U24.o3xmin = o3xmin;
  home->U24.o3xhh = o3xhh;
  home->U26.o3xdd = o3xdd;
  home->U11.N2_IN = N2_IN;
  home->U11.ManSwitch = ManSwitch;
  home->U11.KeySwitch = KeySwitch;
  home->U11.InitShutdown = InitShutdown;
  home->U11.H2O_Pelt_Sp = H2O_Pelt_Sp;
  EF1_0();
}
...
static void BF128_15(void) {
  ...
  home->U19.o3pres = o3pres;
  home->U17.o3lmpv = o3lmpv;
  home->U19.o3lmpsd = o3lmpsd;
  EF16_15();
}

  ...
  if (!(V10)) {
    {
      ...
      ss_set(eng1, 9, _CVT_5(home->U3.temp_SL1));
      ...
      ss_set(eng1, 16, _CVT_6(pres_PUMP));
      ss_set(eng1, 17, _CVT_0(pres_BP2_sp));
      ss_set(eng1, 18, _CVT_6(pres_ECD2));
      ss_set(eng1, 19, ecdA_CH1);
      ss_set(eng1, 20, ecdA_CH2);
    }
  }
}

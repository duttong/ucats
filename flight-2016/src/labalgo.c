...
unsigned char V14 = 0x1F;
unsigned int V15 = 0x3FFF;
unsigned char V16 = 0x7;
...
static void VSET_7_(unsigned short newstate) {
  ...
  switch (newstate) {
    case 2: /* SetECDsCold */ {
        {
          tma_init_state( 1, SetECDsCold_cmds_, "SetECDsCold" ); VSET_12_(1);
        }
      }
      break;
    case 1: /* CheckCarrier */ {
        {
          tma_init_state( 1, CheckCarrier_cmds_, "CheckCarrier" ); VSET_12_(1);
        }
      }
      break;
  }
...
static void BF16_0(void) {
  ...
  { 
  	MR_N2O = MRres( 0 );V14 &= ~0x2;
  }
  { 
  	MR_CH4 = MRres( 1 );V14 &= ~0x4;
  }
  { 
  	MR_SF6 = MRres( 2 );V14 &= ~0x8;
  }
  {
    long int it;
    int subcase;
    ...
    while ( subcase = tma_process( it ) ) {
  	switch (subcase) {
  	  ...
  	  case 4: VSET_8_(1); break;
  	  case 5: VSET_9_(1); break;
  	  case 6: VSET_10_(1); break;
  	  case 7: VSET_10_(2); break;
  	  case 8: VSET_11_(1); break;
  	  case 9: VSET_12_(1); break;
  	  case 10: VSET_12_(2); break;
  	  case 11: VSET_13_(1); break;
  	  case 12: VSET_14_(1); break;
  	  case 13: VSET_15_(1); break;
  	  default:
...
static void BF16_11(void) {
  ...
  if (!(V13)) {
    { if ( (_CVT_1(presL_N2) < N2fail) && (_CVT_1(presL_N2) > 0) ) {
    			...
    			if ( ++N2lowCount >= MAXN2LOWCNTS ) VSET_7_(2);
    		  }

  ...
  if (!(V10)) {
    {
      ...
      ss_set(o3xout, 1, home->U24.o3xyy);
      ss_set(o3xout, 2, home->U24.o3xmm);
      ss_set(o3xout, 3, home->U26.o3xdd);
      ss_set(o3xout, 4, home->U24.o3xhh);
      ss_set(o3xout, 5, home->U24.o3xmin);
      ss_set(o3xout, 6, home->U24.o3xss);
      ss_set(o3xout, 7, o3x);
